...
import com.fitnesscommerce.domain.member.dto.response.TestResponse;
...
public class MemberApiController {
    ...
    public ResponseEntity<TestResponse> issueNewToken(@CookieValue("refreshToken") String refreshToken,
        ...
        TestResponse response = new TestResponse(newAccessToken);
