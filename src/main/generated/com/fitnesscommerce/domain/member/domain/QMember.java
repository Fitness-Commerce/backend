...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = 2009102882L;
    ...
    public final ListPath<String, StringPath> area_range = this.<String, StringPath>createList("area_range", String.class, StringPath.class, PathInits.DIRECT2);
